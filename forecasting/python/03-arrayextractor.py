...
Modified by Maria Yli-Heikkila, Markku Luotamo, UT
...
2024-06 UT added option to monitor disk size usage in LOCAL_SCRATCH, commented out
...
def main():
    ...
    # Monitor the usage of temp directory LOCAL_SCRATCH    
    #tmpdirusage = getfoldersize(tmpdir)
    #print(f'Temporary storage ({ tmpdir }) used: { tmpdirusage } bytes')
