...
def splitDataset(data_folder3, year):
    ...
    #data['dataset'] = data['farmID'].str.rsplit('_', 2).str[1] # When farmID: YEAR_PARCELID_CROPTYPE_TILE
    data['dataset'] = data['farmID'].str.rsplit('_', 3).str[1] # When farmID: YEAR_PARCELID_CROPTYPE_YIELD_TILE
